...
find_path(CUDA_CUDART_INCLUDE cuda_runtime.h PATHS ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES}
                                                   $ENV{CUDA_HOME} PATH_SUFFIXES include
)
find_path(CUDA_CUBLAS_INCLUDE cublas_v2.h PATHS ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES} $ENV{CUDA_HOME}
          PATH_SUFFIXES include
)
find_path(CUDA_CUSOLVER_INCLUDE cusolverDn.h PATHS ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES}
                                                   $ENV{CUDA_HOME} PATH_SUFFIXES include
)
find_library(
  CUDA_CUDART_LIB cudart PATHS ${CMAKE_CUDA_IMPLICIT_LINK_DIRECTORIES} $ENV{CUDA_HOME}
  PATH_SUFFIXES lib64
)
find_library(
  CUDA_CUBLAS_LIB cublas PATHS ${CMAKE_CUDA_IMPLICIT_LINK_DIRECTORIES} $ENV{CUDA_HOME}
  PATH_SUFFIXES lib64
)
find_library(
  CUDA_CUSOLVER_LIB cusolver PATHS ${CMAKE_CUDA_IMPLICIT_LINK_DIRECTORIES} $ENV{CUDA_HOME}
  PATH_SUFFIXES lib64
)
