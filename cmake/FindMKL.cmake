...
set(_mkl_search_paths "${MKL_ROOT}" "${MKL_ROOT}/lib" "${MKL_ROOT}/mkl" "${MKL_ROOT}/compiler")
...
# Find MKL headers
#
find_path(MKL_INCLUDE_DIR mkl.h HINTS ${MKL_ROOT}/include ${MKL_ROOT}/mkl/include)
...
find_package_handle_standard_args(MKL REQUIRED_VARS MKL_INCLUDE_DIR Threads_FOUND _mkl_compiler_found)
      ...
      foreach(_threading "SEQ" "OMP" "TBB")
        ...
        if(MKL_FOUND
          ...
          set_target_properties(
            ${_mkl_tgt} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MKL_INCLUDE_DIR}"
        ...
        foreach(_mpi_impl "MPICH" "OMPI")
          ...
          if(_mkl_blacs_lib
            ...
            set_target_properties(
              ${_blacs_tgt} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MKL_INCLUDE_DIR}"
          ...
          if(_mkl_scalapack_lib AND TARGET ${_blacs_tgt} AND NOT TARGET ${_scalapack_tgt})
            ...
            set_target_properties(
              ${_scalapack_tgt} PROPERTIES INTERFACE_LINK_LIBRARIES "${_scalapack_libs}"
            )
          endif()
        endforeach()
      endforeach()
