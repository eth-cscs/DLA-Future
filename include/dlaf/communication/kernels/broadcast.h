...
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, SizeType, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, float, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, double, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, std::complex<float>, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, std::complex<double>, Device::CPU, internal::CommunicatorWrapper);

#ifdef DLAF_WITH_GPU
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, SizeType, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, float, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, double, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, std::complex<float>, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_SEND_BCAST_ETI(extern, std::complex<double>, Device::GPU, internal::CommunicatorWrapper);
#endif
...
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, SizeType, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, float, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, double, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, std::complex<float>, Device::CPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, std::complex<double>, Device::CPU, internal::CommunicatorWrapper);

#ifdef DLAF_WITH_GPU
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, SizeType, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, float, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, double, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, std::complex<float>, Device::GPU, internal::CommunicatorWrapper);
DLAF_SCHEDULE_RECV_BCAST_ETI(extern, std::complex<double>, Device::GPU, internal::CommunicatorWrapper);
#endif
}
