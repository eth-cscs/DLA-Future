...
void larft_gemv0(cublasHandle_t handle, const SizeType n, SizeType k, const T* v, const SizeType ldv, const T* tau, T* t,
                  const SizeType ldt);
template <class T>
void larft_gemv1(const SizeType n, SizeType k, const T* v, const SizeType ldv, T* t,
...
#define DLAF_CUBLAS_LARFT_GEMV_ETI(kword, Type)                                                   \
  ...
  kword template void larft_gemv1(const SizeType n, SizeType k, const Type* v, const SizeType ldv, \
