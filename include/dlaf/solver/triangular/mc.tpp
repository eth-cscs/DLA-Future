...
namespace dlaf {
  ...
  template <class T>
  void Solver<Backend::MC>::triangular(blas::Side side, blas::Uplo uplo, blas::Op op, blas::Diag diag, T alpha, Matrix<const T, Device::CPU>& mat_a, Matrix<T, Device::CPU>& mat_b) {
  ...
  template <class T>
  void Solver<Backend::MC>::triangular(comm::CommunicatorGrid grid, blas::Side side, blas::Uplo uplo, blas::Op op, blas::Diag diag, T alpha, Matrix<const T, Device::CPU>& mat_a, Matrix<T, Device::CPU>& mat_b) {
    // Check if matrix A is square
    util_matrix::assertSizeSquare(mat_a, "TriangularSolver", "mat_a");
    // Check if block matrix A is square
    util_matrix::assertBlocksizeSquare(mat_a, "TriangularSolver", "mat_a");
