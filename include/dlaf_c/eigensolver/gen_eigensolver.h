...
DLAF_EXTERN_C void dlaf_pssygex(const char uplo, const int n, float* a, const int ia, const int ja,
...
DLAF_EXTERN_C void dlaf_pdsygex(const char uplo, const int n, double* a, const int ia, const int ja,
...
/// @copydoc dlaf_pssygex
DLAF_EXTERN_C void dlaf_pzhegex(const char uplo, const int n, dlaf_complex_z* a, const int ia,
