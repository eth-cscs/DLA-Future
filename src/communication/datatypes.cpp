...
template<> MPI_Datatype mpi_datatype<std::complex<float>>  ::type = MPI_CXX_FLOAT_COMPLEX != MPI_DATATYPE_NULL ? MPI_CXX_FLOAT_COMPLEX : MPI_C_FLOAT_COMPLEX;
template<> MPI_Datatype mpi_datatype<std::complex<double>> ::type = MPI_CXX_DOUBLE_COMPLEX != MPI_DATATYPE_NULL ? MPI_CXX_DOUBLE_COMPLEX : MPI_C_DOUBLE_COMPLEX;
// clang-format on
