...
DLAF_EXTERN_C void C_dlaf_eigensolver_z(int dlaf_context, char uplo, dlaf_complex_z* a,
                                        struct DLAF_descriptor desca, double* w, dlaf_complex_z* z,
                                        struct DLAF_descriptor descz);

DLAF_EXTERN_C void C_dlaf_eigensolver_c(int dlaf_context, char uplo, dlaf_complex_c* a,
