...
DLAF_EXTERN_C void C_dlaf_pssygex(char uplo, const int m, float* a, const int ia, const int ja,
...
DLAF_EXTERN_C void C_dlaf_pdsygex(const char uplo, const int m, double* a, const int ia, const int ja,
                                  const int desca[9], double* b, const int ib, const int jb,
                                  const int descb[9], double* w, double* z, const int iz, const int jz,
                                  const int descz[9], int* info);

DLAF_EXTERN_C void C_dlaf_pchegex(const char uplo, const int m, dlaf_complex_c* a, const int ia,
...
DLAF_EXTERN_C void C_dlaf_pzhegex(const char uplo, const int m, dlaf_complex_z* a, const int ia,
