...
DLAF_EXTERN_C int C_dlaf_triangular_multiplication_c(const int dlaf_context, const char side,
                                                     const char uplo, const char op, const char diag,
                                                     const dlaf_complex_c alpha,
                                                     const dlaf_complex_c* a,
                                                     const struct DLAF_descriptor desca,
                                                     dlaf_complex_c* b,
                                                     const struct DLAF_descriptor descb);

DLAF_EXTERN_C int C_dlaf_triangular_multiplication_z(const int dlaf_context, const char side,
                                                     const char uplo, const char op, const char diag,
                                                     const dlaf_complex_z alpha,
                                                     const dlaf_complex_z* a,
                                                     const struct DLAF_descriptor desca,
                                                     dlaf_complex_z* b,
                                                     const struct DLAF_descriptor descb);
...
DLAF_EXTERN_C void C_dlaf_pstrmm(const char side, const char uplo, const char op, const char diag,
                                 ...
                                 const int ia, const int ja, const int desca[9], float* b,
...
DLAF_EXTERN_C void C_dlaf_pdtrmm(const char side, const char uplo, const char op, const char diag,
                                 ...
                                 const int ia, const int ja, const int desca[9], double* b,
                                 const int ib, const int jb, const int descb[9]);
